...
(function () {
  ...
  const problems = [
    ...
    add({
      ...
      answerKind: "set",
      answer: "{1}",
      verify: { m: "critical", f: "\\ln x-x", range: [0.05, 12] },
      timeLimit: 40,
    ...
    add({
      ...
      answerKind: "interval",
      answer: "(-2, 2)",
      verify: { m: "domain", f: "\\ln(4-x^2)", range: [-10, 10] },
      timeLimit: 45,
      tags: ["domain", "log"],
    ...
    add({
      ...
      answerKind: "interval",
      answer: "(1, inf)",
      verify: { m: "domain", f: "\\ln(\\ln x)", range: [-5, 60] },
      timeLimit: 60,
    ...
    add({
      ...
      answerKind: "interval",
      answer: "(0, e)",
      verify: { m: "increasing", f: "\\frac{\\ln x}{x}", range: [-5, 40] },
      timeLimit: 65,
