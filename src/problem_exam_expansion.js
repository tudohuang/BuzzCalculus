(function () {
  ...
  [
    ...
    ["exam-lim-002", "\\lim_{x\\to0}\\frac{\\ln(1+2x)-2x+2x^2}{x^3}", "8/3", ["taylor", "log"], "Use log(1+u)=u-u^2/2+u^3/3+... with u=2x."],
    ...
    ["exam-lim-019", "\\lim_{x\\to\\infty}x\\left(\\ln(x+1)-\\ln x\\right)", "1", ["log-limit"], "Rewrite as x log(1+1/x)."],
  ...
  [
    ["exam-der-003", "\\frac{d}{dx}\\left(\\frac{\\ln x}{x}\\right)", "(1-log(x))/x^2", "x", ["quotient-rule", "log"], "Use quotient rule or x^{-1} log x."],
    ...
    ["exam-der-006", "\\frac{d}{dx}\\ln\\left(\\sqrt{1+x^2}+x\\right)", "1/sqrt(1+x^2)", "x", ["log", "radical"], "This is the derivative of asinh x."],
    ...
    ["exam-der-010", "\\frac{d}{dx}\\left(x\\ln(1+x^2)\\right)", "log(1+x^2)+2*x^2/(1+x^2)", "x", ["product-rule", "log"], "Product rule plus chain rule."],
    ...
    ["exam-der-015", "\\frac{d}{dx}\\left(\\int_x^{x^2}\\ln(1+t^2)\\,dt\\right)", "2*x*log(1+x^4)-log(1+x^2)", "x", ["fundamental-theorem", "chain-rule"], "Differentiate both variable limits."],
    ...
    ["exam-der-018", "\\frac{d}{dx}\\ln(\\sec x+\\tan x)", "sec(x)", "x", ["trig", "log"], "This standard derivative equals sec x."],
  ...
  [
    ...
    ["exam-int-015", "\\int \\frac{1}{x\\ln x}\\,dx", "log(log(x))", ["substitution", "log"], "Let u=log x."],
    ["exam-int-016", "\\int \\frac{\\cos(\\ln x)}{x}\\,dx", "sin(log(x))", ["substitution", "trig"], "Let u=log x."],
  ...
  [
    ...
    ["exam-int-025", "\\int_0^1\\ln x\\,dx", "-1", ["definite-integral", "improper-integral"], "Integrate x log x - x and take the limit at 0."],
    ["exam-int-026", "\\int_0^\\infty e^{-2x}\\,dx", "1/2", ["definite-integral", "improper-integral"], "The exponential tail gives 1/2."],
    ["exam-int-028", "\\int_0^1 x\\ln(1+x^2)\\,dx", "log(2)-1/2", ["definite-integral", "substitution", "log"], "Let u=1+x^2 and integrate log u."],
  ...
  [
    ...
    ["exam-ser-011", "\\text{求 }\\ln(1+x)\\text{ 的 }x^4\\text{ 係數}", "-1/4", ["taylor", "coefficient"], "The x^n coefficient is (-1)^{n+1}/n."],
