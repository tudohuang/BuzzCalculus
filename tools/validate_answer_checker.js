...
const canonicalProblems = (global.window.BUZZ_PROBLEMS || []).filter((problem) => /^(gap|mob|rel|hc|exam|uni|depth|burst|vc|cx|ap|gp|dm|ph|ch|dd|fd|ch-nest|ch-mix|ch-pow|ch-trap|ch-inv)-/.test(problem.id));
