...
| 項目 | 數字 | 備註 |
| --- | ---: | --- |
| 題目總數 | 2453 | 純微積分；理科秒殺包已於 2026-08 移出 |
| 答案通過獨立數值驗算 | 2174（89%） | 其餘是證明題與定性題，本質上沒有可比對的數值 |
| 有 `source` | 2373 |  |
| 有 `tags` | 2453 | distinct tag 366 個，其中 285 個是技巧 tag |
| 有 `solution` | 2453 | 單段文字 |
| 有作者撰寫 `hints` | 1813 |  |
...
**答案型別分佈**：`numeric` 1639、`expression` 346、`antiderivative` 142、`text` 115、`sketch` 42、`worksheet` 42、`graphtap` 38、`graph` 26、`interval` 20、`set` 17、`proof` 16、`graphslope` 10。

**難度分佈**：R1 182 / R2 418 / R3 631 / R4 748 / R5 363 / R6 111。
