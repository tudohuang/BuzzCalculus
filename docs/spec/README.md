...
| 項目 | 數字 | 備註 |
| --- | ---: | --- |
| 題目總數 | 2492 | 純微積分；理科秒殺包已於 2026-08 移出 |
| 答案通過獨立數值驗算 | 2211（89%） | 其餘是證明題與定性題，本質上沒有可比對的數值 |
| 有 `source` | 2412 |  |
| 有 `tags` | 2492 | distinct tag 376 個，其中 294 個是技巧 tag |
| 有 `solution` | 2492 | 單段文字 |
| 有作者撰寫 `hints` | 1813 |  |
...
**難度分佈**：R1 182 / R2 418 / R3 636 / R4 763 / R5 378 / R6 115。
