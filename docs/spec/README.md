...
| 項目 | 數字 | 備註 |
| --- | ---: | --- |
| 題目總數 | 1723 | 純微積分；理科秒殺包已於 2026-08 移出 |
| 答案通過獨立數值驗算 | 1037（60%） | 其餘是證明題與定性題，本質上沒有可比對的數值 |
| 有 `source` | 1643 |  |
...
| `src/app.js` | 11864 行 | 單一 IIFE，拆分進行中 |
| `styles.css` | 8178 行 |  |
...
**難度分佈**：R1 117 / R2 342 / R3 396 / R4 486 / R5 291 / R6 91。
